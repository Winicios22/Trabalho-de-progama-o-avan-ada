...
public class dispositivo {
   ...
   public void excluirPL(String nome){
       playlists.remove(nome);
       System.out.println("A playlist "+ nome + " foi excluida com sucesso!");
   }
   ...
   public void addMusic(int index, String nome,String artista){
       int i = 0;
       while(playlists.hasNext()){
           PlayList pl = (PlayList) playlists.next();
        if(i == index){
            pl.addMusica(nome, artista);
        }i++;
   }
   }
